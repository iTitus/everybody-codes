...
pub use ec::{
    Client, Quest, read_example_file, read_input_file, read_numbered_example_file, run_part,
};
use std::error::Error;
use std::fs;
...
pub fn scaffold_quest(
    ...
    if !quest_file.exists() {
        ...
        println!(
            "Created quest file [\x1b[0;32m {} \x1b[0m]",
            quest_file.display()
        );
    } else {
    ...
    if !input_file.exists() {
        ...
        println!(
            "Created note file [\x1b[0;32m {} \x1b[0m]",
            input_file.display()
        );
    } else {
    ...
    if !example_file.exists() {
        ...
        println!(
            "Created empty example file [\x1b[0;32m {} \x1b[0m]",
